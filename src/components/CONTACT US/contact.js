...
<TextField id="filled-basic" label="Name" variant="filled" className="input1 mt-4"/>
<TextField id="filled-basic" label="Email" variant="filled" className="input1 mt-2"/>
<TextField id="filled-basic" label="Subject" variant="filled" className="input1 mt-2"/>
<TextField
        ...
        />
          ...
          <div className="col-12 locationsec  ">
            ...
            <p className="address pt-2">
              ...
              mandal, Sangareddy district, Telengana - 502300
            </p>
...
<TextField id="filled-basic" label="Name" variant="filled" className="input1 mt-5"/>
<TextField id="filled-basic" label="Email" variant="filled" className="input1 mt-2"/>
<TextField id="filled-basic" label="Subject" variant="filled" className="input1 mt-2"/>
<TextField
          id="filled-multiline-static"
